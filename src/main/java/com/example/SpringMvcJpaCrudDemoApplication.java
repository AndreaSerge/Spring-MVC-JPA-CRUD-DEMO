...
// vamos a meterle datos a las tablas, eso lo logramos con el método Run de la interfaz CommandLineRunner
public class SpringMvcJpaCrudDemoApplication implements CommandLineRunner {

	// Para que esto persista, se necesita de los servicios que guardan datos en las bases de datos
